...
class Ghost():
    ...
    def flashGhost(self, screen, ghost_color, screen_width, screen_height):
        ...
        img = pygame.image.load("C:/Users/Asma Makhdoom/Downloads/pac_ghost.png")
        screen.blit(img, (self.x_location, self.y_location))

# -------- Main Program Loop -----------
ghost = Ghost(50,50,10,2,20)
ghost2 = Ghost(250,150,5,3,20)
ghost3 = Ghost(150,50,5,3,20)
ghost4 = Ghost(30,100,5,3,20)
...
while gameloop:
    ...
    ghost3.flashGhost(screen,BLUE,SCREEN_WIDTH,SCREEN_HEIGHT)
    ghost4.flashGhost(screen,BLUE,SCREEN_WIDTH,SCREEN_HEIGHT)
